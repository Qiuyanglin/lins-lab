...
<div style="display:grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap:24px; margin: 2rem 0;">
  ...
  <div style="text-align:center;">
    <img src="xinaoji.jpg" alt="Xinao Ji" style="width:100%; max-width:260px; border-radius:12px; margin-bottom:16px;">
  ...
  <div style="text-align:center;">
    <img src="yidisun.jpg" alt="Yidi Sun" style="width:100%; max-width:260px; border-radius:12px; margin-bottom:16px;">
