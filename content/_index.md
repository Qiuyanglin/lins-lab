    ...
    content:
      text: |
        <div style="display:flex;gap:32px;align-items:flex-start;flex-wrap:wrap;margin-top:12px;">
          ...
          <div style="flex:1;min-width:280px;max-width:1180px;line-height:1.78;">
            ...
            <div style="margin:0 0 14px 0;">在 集成电路顶级会议ISSCC、VLSI、与顶级期刊IEEE JSSC/TBCAS 等发表论文 30 余篇，授权美国专利 2 项。</div>
